...
<script setup>
  ...
  import { TtPreviewFileModal } from 'tt-components';
  ...
  const fileList = ref([
    ...
    {
      name: '示例图片2',
      url: 'https://kdiot-dev-1305504517.cos.ap-chengdu.myqcloud.com/customer/202503/24/zeaL0tT410UGX2AQ8XbW.JPG',
    },
    {
      name: '示例视频',
      url: 'https://kdiot-dev-1305504517.cos.ap-chengdu.myqcloud.com/public/202509/04/ftofU8OH1APkAN6Wu3Ut.mp4',
    },
  ]);
